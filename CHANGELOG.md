...
* **engine:** update shared engines and maintenance tool ([8c5f65d](https://github.com/maxgfr/reconstruct/commit/8c5f65d82ffca794c94c4fb9947a199232d1b963))

## [2.23.7](https://github.com/maxgfr/reconstruct/compare/v2.23.6...v2.23.7) (2026-09-13)


### Bug Fixes

* **engine:** update shared engines and maintenance tool ([3119486](https://github.com/maxgfr/reconstruct/commit/3119486e305164489320337ab5d7b849dc1c5c21))
...
* **skills:** preserve manual invocation across agent hosts ([58abcd0](https://github.com/maxgfr/reconstruct/commit/58abcd0f35df9f1a9ce7f1db75bbc670f97ca272))
...
* **engine:** update shared engines and maintenance tool ([b7dea4d](https://github.com/maxgfr/reconstruct/commit/b7dea4d1afab581d63e26a46bf7063a0eed5fb0f))

## [2.23.2](https://github.com/maxgfr/reconstruct/compare/v2.23.1...v2.23.2) (2026-09-08)


### Bug Fixes

* **engine:** separate workflow maintenance from automatic repins ([6be50f8](https://github.com/maxgfr/reconstruct/commit/6be50f87d5079c48d979c0ecc354794a3fa9d558))
...
* **engine:** re-pin vendored engines ([d4fe61a](https://github.com/maxgfr/reconstruct/commit/d4fe61ab23652150e0d464a16f293e54d087c757))

# [2.21.0](https://github.com/maxgfr/reconstruct/compare/v2.20.0...v2.21.0) (2026-09-03)


### Features

* **engine:** re-pin vendored engines ([5be4ea4](https://github.com/maxgfr/reconstruct/commit/5be4ea4896307209fe6f3f469cc8afecac6f8f22))

# [2.20.0](https://github.com/maxgfr/reconstruct/compare/v2.19.0...v2.20.0) (2026-09-02)


### Features

* **engine:** re-pin vendored engines ([d0fc463](https://github.com/maxgfr/reconstruct/commit/d0fc4634c44cad419495ff29db3ce78377e5248f))

# [2.19.0](https://github.com/maxgfr/reconstruct/compare/v2.18.1...v2.19.0) (2026-08-31)


### Features

* **engine:** re-pin vendored engines ([bc0cc7c](https://github.com/maxgfr/reconstruct/commit/bc0cc7cff5683d29bcb6d5abd0c7be0fc6576557))

## [2.18.1](https://github.com/maxgfr/reconstruct/compare/v2.18.0...v2.18.1) (2026-08-25)


### Bug Fixes

* make reconstruct compatible with Codex ([f91c7f4](https://github.com/maxgfr/reconstruct/commit/f91c7f4d7c0148c9429820b378ae544a309f91bb))
...
* **engine:** re-pin codeindex v2.27.1 ([9e32d2f](https://github.com/maxgfr/reconstruct/commit/9e32d2f74ecf3b8ad6b852c6d877ff8bcc739ed0))

# [2.16.0](https://github.com/maxgfr/reconstruct/compare/v2.15.0...v2.16.0) (2026-08-02)


### Features

* **engine:** re-pin codeindex v2.26.0 ([0b4d005](https://github.com/maxgfr/reconstruct/commit/0b4d005db65f0ca0504d1e02b101dbb5dc0d35ef))

# [2.15.0](https://github.com/maxgfr/reconstruct/compare/v2.14.0...v2.15.0) (2026-08-01)


### Features

* **engine:** re-pin codeindex v2.24.2 ([d2a0269](https://github.com/maxgfr/reconstruct/commit/d2a02692c8d9c4ac7ebb2045dc38404d36b4c7c6))

# [2.14.0](https://github.com/maxgfr/reconstruct/compare/v2.13.1...v2.14.0) (2026-07-31)


### Features

* **engine:** re-pin codeindex v2.22.0 ([c72fd2c](https://github.com/maxgfr/reconstruct/commit/c72fd2cb0a86862c1bf35d94134252bac415c4cb))

## [2.13.1](https://github.com/maxgfr/reconstruct/compare/v2.13.0...v2.13.1) (2026-07-30)


### Bug Fixes

* **mcp:** serve the nested references, not just the top level ([9bcc225](https://github.com/maxgfr/reconstruct/commit/9bcc225e232d59d51f5d3cb152bcdd36db986537))

# [2.13.0](https://github.com/maxgfr/reconstruct/compare/v2.12.0...v2.13.0) (2026-07-29)


### Features

* **mcp:** serve reconstruct over the Model Context Protocol ([df14af7](https://github.com/maxgfr/reconstruct/commit/df14af72b83d7dcc53ae57816c005ec21aca6639))

# [2.12.0](https://github.com/maxgfr/reconstruct/compare/v2.11.1...v2.12.0) (2026-07-26)


### Features

* **engine:** re-pin codeindex v2.20.1 ([0e4920e](https://github.com/maxgfr/reconstruct/commit/0e4920ef9de845fcb9a59e0403409361f36508cd))
...
* **engine:** re-pin codeindex v2.17.0 ([14c27e0](https://github.com/maxgfr/reconstruct/commit/14c27e07169822d7361e0e4593282d799b94872b))

# [2.8.0](https://github.com/maxgfr/reconstruct/compare/v2.7.0...v2.8.0) (2026-07-24)


### Features

* **engine:** re-pin codeindex v2.16.0 ([f90849a](https://github.com/maxgfr/reconstruct/commit/f90849aa3771e45f2da63397a3172ebb56854ffa))

# [2.7.0](https://github.com/maxgfr/reconstruct/compare/v2.6.0...v2.7.0) (2026-07-24)


### Features

* **engine:** re-pin codeindex v2.15.0 ([aecc9d5](https://github.com/maxgfr/reconstruct/commit/aecc9d58eafa9ecaef3f96dd907819859f163855))

# [2.6.0](https://github.com/maxgfr/reconstruct/compare/v2.5.0...v2.6.0) (2026-07-24)


### Features

* **engine:** re-pin codeindex v2.14.0 ([c494d2c](https://github.com/maxgfr/reconstruct/commit/c494d2cfb3cf07681c71c3756ca697960c7bad64))

# [2.5.0](https://github.com/maxgfr/reconstruct/compare/v2.4.0...v2.5.0) (2026-07-24)


### Features

* **engine:** re-pin codeindex v2.13.0 ([2eb6433](https://github.com/maxgfr/reconstruct/commit/2eb6433675a6ef9b86fbaedc19ef9470bffb1bcc))
...
* **engine:** re-pin the codeindex engine at v2.10.0 ([1dbfb4a](https://github.com/maxgfr/reconstruct/commit/1dbfb4a30e19d396444d035bde6040c0d6bcfbe9))
...
* **orchestrate:** emit the enrich map-reduce / review / adjudication fan-outs + contracts + runbook ([#14](https://github.com/maxgfr/reconstruct/issues/14)) ([7ec8a50](https://github.com/maxgfr/reconstruct/commit/7ec8a5042fa258689ef1dddf3b0cc90866b87792))
...
* first-class monorepo support (detection, per-workspace attribution, dependency graph) ([#9](https://github.com/maxgfr/reconstruct/issues/9)) ([31f49c1](https://github.com/maxgfr/reconstruct/commit/31f49c1e79abebf2f4de1f2484d7a36d7496378a))
