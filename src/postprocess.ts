...
import { mergeArtifacts, summarize } from "./prd/bundle.js";
 ...
 * then returns only the requested `SUMMARY.md` / `RECONSTRUCTION.md` artifacts.
 *
 * `mergeArtifacts` excludes any pre-existing `SUMMARY.md` / `RECONSTRUCTION.md`,
