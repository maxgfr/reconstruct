...
routes — with their HTTP method — for nine framework families** (Next.js, Express, Fastify,
Flask, FastAPI, NestJS, Django, Rails, Go) through a small pluggable registry. The deeper
