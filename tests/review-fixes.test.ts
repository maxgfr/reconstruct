...
describe("templates: well-formed fill-in tables (review #13)", () => {
  ...
  const opts = { mode: "preserve", level: "light", fidelity: "describe", granularity: "coarse", include: [], exclude: [], json: false, maxEmbedBytes: 16000, repo: "/x", out: "/o", merge: false, summary: false, standalone: false, scratch: false, plan: "", tdd: false } as Options;
